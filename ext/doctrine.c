...
static PHP_MINIT_FUNCTION(doctrine)
{
#if PHP_VERSION_ID < 50500
...
#ifndef ZEPHIR_RELEASE
static PHP_MSHUTDOWN_FUNCTION(doctrine)
{
 ...
 */
static void php_zephir_init_globals(zend_doctrine_globals *zephir_globals TSRMLS_DC)
{
...
static PHP_RINIT_FUNCTION(doctrine)
{

	zend_doctrine_globals *zephir_globals_ptr = ZEPHIR_VGLOBAL;
...
static PHP_RSHUTDOWN_FUNCTION(doctrine)
{
...
static PHP_MINFO_FUNCTION(doctrine)
{
	php_info_print_box_start(0);
	php_printf("%s", PHP_DOCTRINE_DESCRIPTION);
	php_info_print_box_end();

	php_info_print_table_start();
	php_info_print_table_header(2, PHP_DOCTRINE_NAME, "enabled");
	php_info_print_table_row(2, "Author", PHP_DOCTRINE_AUTHOR);
	php_info_print_table_row(2, "Version", PHP_DOCTRINE_VERSION);
	php_info_print_table_row(2, "Powered by Zephir", "Version " PHP_DOCTRINE_ZEPVERSION);
	php_info_print_table_end();


}

static PHP_GINIT_FUNCTION(doctrine)
{
	php_zephir_init_globals(doctrine_globals TSRMLS_CC);
}

static PHP_GSHUTDOWN_FUNCTION(doctrine)
{
...
zend_module_entry doctrine_module_entry = {
	...
	ZEND_MODULE_GLOBALS(doctrine),
	PHP_GINIT(doctrine),
	PHP_GSHUTDOWN(doctrine),
	NULL,
	STANDARD_MODULE_PROPERTIES_EX
};

#ifdef COMPILE_DL_DOCTRINE
